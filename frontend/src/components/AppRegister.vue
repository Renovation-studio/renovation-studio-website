<template>
  <div>
    <form @submit.prevent="checkForm">
      ...
      <!--            </ul>-->
      <!--            </p>-->
      <p class="pagename">Регистрация</p>
      ...
      <div class="tooltip">
        <i
          ...
          @mouseover="handleTooltipShow"
          @mouseout="handleTooltipHide"
        ></i>
        <span
          v-show="showTooltip"
          class="tooltiptext"
        >
          Расскажите, какой ремонт вы планируете
        </span>
      </div>
      ...
      <div class="checkbox-row">
        <div class="checkbox-wrapper">
          ...
          <label
            ...
            class="agree"
          >
            Я прочитал и согласен с условиями использования сайта, включая политику
            конфиденциальности и правила обработки персональных данных
          </label>
        </div>
      </div>
